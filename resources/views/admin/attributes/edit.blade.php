...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Admin / Attributes /</span> Edit
    </h4>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.attributes.update', $attribute->id) }}" method="POST" id="attributeForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="mb-3 col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_variation" name="is_variation" 
                                           value="1" {{ old('is_variation', $attribute->is_variation) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                       value="1" {{ old('is_active', $attribute->is_active) ? 'checked' : '' }}>
                                        ...
                                        @foreach($attribute->attributeValues as $index => $value)
                                            <div class="row mb-3 value-row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="values[{{ $index }}][value]" 
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control" name="values[{{ $index }}][description]" rows="2">{{ $value->description }}</textarea>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="values[{{ $index }}][is_active]" 
                                                               value="1" {{ $value->is_active ? 'checked' : '' }}>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary me-2">
                                <i class="ri-save-line me-1"></i> Update Attribute
                            </button>
...
<script>
let valueIndex = {{ $attribute->attributeValues ? $attribute->attributeValues->count() : 0 }};
...
function addValueRow() {
    ...
    valueRow.innerHTML = `
        ...
        <div class="col-12">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="values[${valueIndex}][is_active]" value="1" checked>
                <label class="form-check-label">
                    Active
                </label>
            </div>
